# SSA header links (AI governance declaration)

The Global Settings screen includes an option labeled:

- “AI Governance (SSA) — Declare AI governance links in the site header (SSA)”

When enabled, Better Robots.txt adds optional link relations in the HTML `<head>`.
